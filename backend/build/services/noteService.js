...
const addEntry = (noteObject, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newNote = Object.assign(Object.assign({}, noteObject), { creationDate, checked: false, user: user.id });
...
const deleteEntry = (id, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (note.noteCollection !== null) {
        yield noteCollection_1.default.updateOne({ _id: note.noteCollection }, { $pull: { notes: id } });
    }
...
const updateEntry = (id, user, note) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.id.toString() !== note.user.toString())
        throw new mongoose_1.MongooseError("AuthError");
    if (!((_a = noteToUpdate.noteCollection) === null || _a === void 0 ? void 0 : _a.equals(note.noteCollection))) {
        if (note.noteCollection !== null) {
            const collection = yield noteCollection_1.default.findById(note.noteCollection);
            if (!collection)
                throw new mongoose_1.MongooseError("DocumentNotFoundError");
            yield noteCollection_1.default.updateOne({ _id: note.noteCollection }, { $addToSet: { notes: id } });
        }
        yield noteCollection_1.default.updateOne({ _id: noteToUpdate.noteCollection }, { $pull: { notes: note.id } });
    }
