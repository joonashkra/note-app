...
router.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id, title, description, creationDate, deadlineDate, checked, user } = parsedNote.data;
    const note = {
    ...
    const updatedNote = yield noteService_1.default.updateEntry(req.params.id, req.user, note);
