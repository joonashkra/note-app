...
router.get("/", middleware_1.default.checkAuth, (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield userService_1.default.getEntries();
    res.send(users);
}));
router.get("/:id", middleware_1.default.checkAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user)
...
router.delete("/:id", middleware_1.default.checkAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
